---
titel: "„Bei einer Erkältung helfen Antibiotika“"
behauptung: "Wer eine hartnäckige Erkältung oder einen grippalen Infekt hat, sollte Antibiotika nehmen – dann wird man schneller wieder gesund."
kurzantwort: "Erkältungen werden von Viren ausgelöst, Antibiotika wirken aber nur gegen Bakterien. Hochwertige Studien zeigen: Bei einer einfachen Erkältung lindern Antibiotika die Beschwerden nicht und verkürzen die Krankheit nicht – sie verursachen aber bei etwa jedem Zehnten Nebenwirkungen. Sinnvoll sind sie nur, wenn nachweislich Bakterien beteiligt sind."
urteil: "falsch"
themen: ["gesundheit"]
...
technik_titel: "Falsche Ursache-Wirkung (post hoc)"
technik_text: |
...
pruefen: |
  - **Ursache klären:** Viral oder bakteriell? Eine einfache Erkältung ist fast immer viral – und dagegen wirken Antibiotika nicht. Frag in der Praxis gezielt nach, ob ein Antibiotikum hier überhaupt etwas bringt.
  - **Selbstheilung mitdenken:** Eine Erkältung klingt meist nach ein bis zwei Wochen von allein ab. Die Besserung nach Tabletteneinnahme ist kein Beleg für deren Wirkung.
  - **Quelle prüfen:** Auf `gesundheitsinformation.de` (IQWiG) nach „Erkältung" und „Antibiotika" suchen – dort steht die Studienlage neutral und mit Belegen aufbereitet.
  - **Größeres Bild:** Unnötige Antibiotika fördern Resistenzen. Die WHO ordnet das als eine der größten Gesundheitsgefahren ein – ein Grund mehr, sie nur bei klarer Indikation zu nehmen.
---
