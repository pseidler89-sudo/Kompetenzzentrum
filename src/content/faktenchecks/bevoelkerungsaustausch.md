...
quellen:
  - titel: "Verfassungsschutzberichte – Rechtsextremismus, ‚Großer Austausch‘ als Ideologieelement"
    ...
    art: "primaer"
  - titel: "Bevölkerung und demografischer Wandel – Daten und Vorausberechnungen"
...
technik_titel: "Verschwörungserzählung"
technik_text: |
...
pruefen: |
  - Frag nach **konkreten Belegen** für den „Plan": Wer genau, welches Dokument, welche Entscheidung? Verschwörungserzählungen bleiben hier stets vage.
  - Schau die **Bevölkerungsdaten** bei Destatis selbst an – inklusive der Ursachen von Migration und Geburtenentwicklung. Wandel ja, Geheimplan nein.
  - Lies die Einordnung im **Verfassungsschutzbericht** und bei der **bpb**: Sie erklären Herkunft und Funktion der Erzählung.
  - Teste die **Unfälschbarkeit:** Welche Beobachtung würde die Behauptung widerlegen? Gibt es keine, ist es keine überprüfbare Tatsache.
---
