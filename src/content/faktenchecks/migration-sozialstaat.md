---
titel: "„Migranten kosten den Sozialstaat nur und zahlen nichts ein“"
behauptung: "Zuwanderer leben auf Kosten der Steuerzahler und sind unterm Strich ein Verlustgeschäft."
kurzantwort: "Pauschal stimmt das nicht. Studien zeigen, dass Zugewanderte über ein Erwerbsleben hinweg im Schnitt Steuern und Beiträge zahlen – oft mehr, als sie an Leistungen erhalten. Entscheidend ist die Arbeitsmarktintegration, nicht die Herkunft; und ohne Zuwanderung würden die Renten- und Pflegekassen schneller unter Druck geraten."
urteil: "groesstenteils-falsch"
themen: ["migration", "wirtschaft-soziales"]
techniken: ["cherry-picking", "falsche-gleichsetzung", "fehlender-bezugswert"]
zusammenfassung: "Was Zuwanderung den Sozialstaat wirklich kostet und einbringt – fiskalische Bilanz, Rolle der Erwerbstätigkeit und der Demografie."
status: "geprueft"
veroeffentlicht: 2026-05-31
mitwirkende: ["Kompetenzzentrum-Redaktion"]
verwandt: ["buergergeld-arbeitsanreiz", "migration-kriminalstatistik", "bevoelkerungsaustausch"]
quellen:
  - titel: "Migration und Sozialstaat / fiskalische Effekte der Zuwanderung (Studien)"
    herausgeber: "Sachverständigenrat für Integration und Migration (SVR)"
    url: "https://www.svr-migration.de"
    art: "sekundaer"
  - titel: "Bevölkerung mit Migrationshintergrund, Erwerbstätigkeit, Sozialleistungen"
    herausgeber: "Statistisches Bundesamt (Destatis)"
    url: "https://www.destatis.de/DE/Themen/Gesellschaft-Umwelt/Bevoelkerung/Migration-Integration/_inhalt.html"
    art: "primaer"
  - titel: "Fiskalische Wirkungen von Zuwanderung / Generationenbilanz (Bonin u.a.)"
    herausgeber: "Bertelsmann Stiftung / ZEW"
    url: "https://www.bertelsmann-stiftung.de"
    art: "sekundaer"
  - titel: "Migration und Arbeitsmarkt – Daten und Analysen"
    herausgeber: "Institut für Arbeitsmarkt- und Berufsforschung (IAB)"
    url: "https://www.iab.de"
    art: "primaer"
einleitung: |
  Ob Zuwanderung den Sozialstaat be- oder entlastet, hängt fast vollständig davon ab, ob Menschen in Arbeit kommen – nicht von ihrem Pass. Wer arbeitet, zahlt Steuern und Sozialbeiträge. Und in einer alternden Gesellschaft hält genau das die Renten- und Pflegekassen am Laufen.
einstieg: |
...
technik_titel: "Cherry Picking & falsche Gleichsetzung"
technik_text: |
...
pruefen: |
  - Schau bei **Destatis** nach Erwerbstätigenquoten von Menschen mit Migrationshintergrund – die „zahlt nichts ein"-Erzählung lässt sich daran direkt prüfen.
  - Lies eine **Generationenbilanz** (Bertelsmann/ZEW) und achte auf die Annahmen (Diskontsatz, Erwerbsverlauf) – sie erklären, warum Zahlen auseinandergehen.
  - Frag bei jeder Kostenzahl: Sind die **Einnahmen** gegengerechnet? Wird zwischen **Fachkräften, Studierenden und Schutzsuchenden** unterschieden?
---
