...
zusammenfassung: "Der Weg von der Behauptung zum geprüften Faktencheck – und die Regeln, die dabei gelten."
reihenfolge: 1
...
Jeder Beitrag bietet drei Stufen, zwischen denen Leser:innen frei wählen:

- **Einstieg** – verständlich ohne Vorwissen.
- **Vertiefung** – Zahlen, Kontext, Zusammenhänge.
- **Wissenschaftlich** – Primärquellen, Methodik, statistische Fallstricke.
...
Fehler passieren. Wenn wir einen machen, korrigieren wir ihn **offen** – nachvollziehbar über die Versionsgeschichte auf GitHub. Jede:r kann jede Änderung einsehen und hinterfragen.
